...
def build_dataset(cfg, default_args=None):
    from mmdet3d.datasets.dataset_wrappers import CBGSDataset,RepeatDataset_self
    ...
    elif cfg["type"] == "RepeatDataset_self":
        dataset = RepeatDataset_self(build_dataset(cfg["dataset"], default_args), cfg["times"])
