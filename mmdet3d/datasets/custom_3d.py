...
class Custom3DDataset(Dataset):
    ...
    def prepare_train_data(self, index):
        ...
        #t1 = time.time()
        #print("get_data_info time", t1-s1)
        if input_dict is None:
            return None
        self.pre_pipeline(input_dict)
        #t2 = time.time()
        #print("pre pipeline time", t2-t1)

        example = self.pipeline(input_dict)
        #t3 = time.time()
        #print("pipeline time", t3-t2)
        ...
        if self.filter_empty_gt and (
            ...
            return None
        #t4 = time.time()
        #print("filter example gt  time", t4-t3)

        #s2 = time.time()
        #print("prepare train data time", s2-s1)
        return example
